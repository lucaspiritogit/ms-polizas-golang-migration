...
type Poliza struct {
	...
	CodigoRamo          int64  `json:"codigoRamo" gorm:"column:CODIGO_RAMO;type:bigint;not null"`
	...
	NroPoliza           string `json:"nroPoliza" gorm:"column:NRO_POLIZA;type:varchar(24);not null"`
	NroEndoso           int64  `json:"nroEndoso" gorm:"column:NRO_ENDOSO;type:bigint;not null"`
